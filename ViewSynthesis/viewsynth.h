...
void GaussianFilter(const Mat src, Mat& dest, int r, float sigma, int method=FILTER_SLOWEST, const Mat& mask=Mat());
//void GaussianFilter(const Mat src, Mat& dest, int r, float sigma, int method=FILTER_SLOWEST);
